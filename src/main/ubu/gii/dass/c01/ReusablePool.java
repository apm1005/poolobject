...
public final class ReusablePool {
	...
	/**
	 * Método singleton que crea u obtiene la única instancia del Pool que gestiona
	 * dos objetos Reusables
	 * 
	 ...
	 * @exception NotFreeInstanceException si no hay instancias de objetos reusables
	 *                                     disponibles
	 * 
	 */
	...
	/**
	 * El cliente libera una instancia del objeto Reusable y se guarda en el Pool
	 * para poder ser utilizada por otro cliente.
	 * 
	 * @param r una instancia objeto reusable
	 * @exception DuplicatedInstanceException si el objeto reusable ya existe en el
	 *                                        pool
	 * 
	 */
